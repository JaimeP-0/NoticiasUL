        ...
        if self._pool is None:
            try:
                pool_config = {
                    ...
                    'pool_size': 3,  # Reducido a 3 para BD remota (menos overhead)
                    ...
                    'use_unicode': True,
                    'connect_timeout': 5,  # Reducido de 10 a 5 segundos
                    'buffered': True,
                    'compress': True  # Habilitar compresión de protocolo MySQL
                }
